...
export const { openEstateModal, closeEstateModal, setCurrentEstate, setUpdatePage, openApplyForEstateModal, closeApplyForEstateModal, setCurrentEstateApplication } = estateSlice.actions
